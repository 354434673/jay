          ...
          <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span>Hello:<shiro:principal/>
...
<div class="row">
    <div class="col-sm-6 col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">联系人列表<span class="label label-warning">+10</span></div>
    ...
    <div class="col-sm-6 col-md-6">
        <div class="panel panel-default">
            ...
            <footer>
                ...
                <p class="pull-right"><a href="http://www.portnine.com/bootstrap-themes" target="_blank">本项目仅供个人所有</a> by <a href="http://www.portnine.com" target="_blank">Portnine</a></p>
                <p>© 2016 <a href="http://www.portnine.com" target="_blank">Portnine</a></p>
            </footer>
        </div>
    </div>
